...
// Theme is "rose-pine-moon-color-theme.json" taken from https://github.com/rose-pine/vscode/blob/main/themes/rose-pine-moon-color-theme.json
// Convert themes at https://vsctim.vercel.app/
export const ROSE_PINE_MOON = "Rose-Pine-Moon";
...
monaco.editor.defineTheme(ROSE_PINE_MOON, theme);
